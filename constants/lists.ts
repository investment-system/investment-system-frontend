...
export const malaysiaBanks = [
    ...
    {value: "bsn", label: "Bank Simpanan Nasional (BSN)"},
    {value: "bank_of_china", label: "Bank of China (Malaysia)"},
    {value: "icbc", label: "Industrial and Commercial Bank of China (ICBC)"},
